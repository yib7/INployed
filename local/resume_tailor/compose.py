...
def rephrase(jd: str, job_title: str, sel: Dict[str, Any],
    ...
    system = (
        ...
        "still re-phrases ONLY its own group's atoms. A number or figure that appears only in "
        "another group's atoms is off-limits for this bullet, even when this group's own atom "
        "mentions the same subject. An atom naming the subject without that figure licenses "
        "the subject alone, so state the subject the way that atom does and leave the "
        "figure to the bullet whose atoms carry it.\n"
