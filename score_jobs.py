...
# but the VM has no `claude` CLI on PATH, so make_pool() below silently falls
# back to Gemini regardless of a pushed `provider: claude`. Absent the file
# entirely, the scorer behaves exactly as before.
